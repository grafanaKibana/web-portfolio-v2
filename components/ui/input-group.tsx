...
/**
 * Renders the shared InputGroup UI primitive.
 *
...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "field-surface field-shell group/input-group relative flex w-full min-w-0 items-center transition-[color,box-shadow,background-color] outline-none in-data-[slot=combobox-content]:focus-within:border-inherit in-data-[slot=combobox-content]:focus-within:ring-0 has-[[data-slot=input-group-control]:focus-visible]:border-ring has-[[data-slot=input-group-control]:focus-visible]:ring-3 has-[[data-slot=input-group-control]:focus-visible]:ring-ring/30 has-[[data-slot][aria-invalid=true]]:border-destructive has-[[data-slot][aria-invalid=true]]:ring-3 has-[[data-slot][aria-invalid=true]]:ring-destructive/20 has-[>[data-align=block-end]]:h-auto has-[>[data-align=block-end]]:flex-col has-[>[data-align=block-start]]:h-auto has-[>[data-align=block-start]]:flex-col has-[>textarea]:h-auto dark:has-[[data-slot][aria-invalid=true]]:ring-destructive/40 has-[>[data-align=block-end]]:[&>input]:pt-3 has-[>[data-align=block-start]]:[&>input]:pb-3 has-[>[data-align=inline-end]]:[&>input]:pr-1.5 has-[>[data-align=inline-start]]:[&>input]:pl-1.5",
        className
      )}
      {...props}
    />
...
/**
 * Renders the shared InputGroupAddon UI primitive.
 *
 * @param className - Optional classes merged with the default styles.
...
/**
 * Renders the shared InputGroupButton UI primitive.
 *
 * @param className - Optional classes merged with the default styles.
 * @param type - Native button behavior.
...
/**
 * Renders the shared InputGroupText UI primitive.
 *
 * @param className - Optional classes merged with the default styles.
 * @param props - Remaining properties forwarded to the underlying primitive.
 * @returns The configured UI element.
...
/**
 * Renders the shared InputGroupInput UI primitive.
 *
 * @param className - Optional classes merged with the default styles.
 * @param props - Remaining properties forwarded to the underlying primitive.
 * @returns The configured UI element.
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        "h-full flex-1 rounded-none border-0 shadow-none ring-0 [background:none] focus-visible:ring-0 aria-invalid:ring-0",
        className
      )}
      {...props}
    />
...
/**
 * Renders the shared InputGroupTextarea UI primitive.
 *
 * @param className - Optional classes merged with the default styles.
 * @param props - Remaining properties forwarded to the underlying primitive.
 * @returns The configured UI element.
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      data-slot="input-group-control"
      className={cn(
        "flex-1 resize-none rounded-none border-0 py-2.5 shadow-none ring-0 [background:none] focus-visible:ring-0 aria-invalid:ring-0",
        className
      )}
      {...props}
    />
