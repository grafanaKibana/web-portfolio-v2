...
test("strict colocation zones enforce resolved aliases, relatives, exports, types, and dynamic imports", async (t) => {
  ...
  await Promise.all([
    ...
    writeFixture(root, "components/not-found-page/not-found-page.tsx"),
    writeFixture(root, "components/not-found-page/private-helper.ts"),
  ...
  const cases = [
    ...
    ["app/articles/not-found.tsx", 'import "@/components/not-found-page/not-found-page";', 0],
    ["app/projects/not-found.tsx", 'import "@/components/not-found-page/not-found-page";', 0],
    ["app/not-found.tsx", 'import "@/components/not-found-page/not-found-page";', 0],
    ["app/articles/not-found.tsx", 'import "@/components/not-found-page/private-helper";', 1],
