    ...
    <main id="main" tabIndex={-1} className="page-shell-gutter w-full flex-1 py-12 [overflow-wrap:anywhere] focus:outline-none lg:py-20">
      <article className="text-base leading-7">
        <header>
          ...
          <p className="mt-6 leading-7 text-content-foreground" data-page-motion-intro>This page explains the two machine-readable text files published by this portfolio.</p>
        </header>

        <section className="mt-10" data-page-motion-rows="children" data-page-motion-section>
          <h2 className="text-2xl leading-[1.875rem] font-semibold tracking-tight" data-page-motion-trigger>llms.txt</h2>
          <p className="mt-4 leading-7 text-content-foreground">The root llms.txt file is a concise Markdown guide that helps language-model agents find the site&apos;s public profile, projects, articles, and site information. It follows the proposal&apos;s minimal structure and is informational only.</p>
          <p className="mt-4">
        ...
        <section className="mt-10" data-page-motion-rows="children" data-page-motion-section>
          <h2 className="text-2xl leading-[1.875rem] font-semibold tracking-tight" data-page-motion-trigger>robots.txt</h2>
          <p className="mt-4 leading-7 text-content-foreground">The root robots.txt file contains crawler directives and the sitemap location when a deployment origin is configured.</p>
          <p className="mt-4">
        ...
        <section className="mt-10" data-page-motion-rows="children" data-page-motion-section>
          <h2 className="text-2xl leading-[1.875rem] font-semibold tracking-tight" data-page-motion-trigger>Permissions and reuse</h2>
          <p className="mt-4 leading-7 text-content-foreground">llms.txt does not replace robots.txt and does not grant permission to crawl, index, train on, reproduce, or redistribute content. Site-content use is described in the Terms &amp; Conditions. A linked repository&apos;s license governs its source code when present; otherwise, these website terms grant no code license.</p>
          <p className="mt-4">
