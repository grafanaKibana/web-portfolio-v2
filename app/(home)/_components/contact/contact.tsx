  ...
  return (
    ...
    >
      ...
      <div className={styles.content}>
        ...
        <div className={styles.links} data-page-motion-row>
          <a
            aria-label={`E-Mail: ${contact.email}`}
            className={clsx(styles.linkRow, "inline-flex min-h-12 max-w-full min-w-0 items-center gap-2.5 text-sm text-muted-foreground transition-colors hover:text-foreground focus-visible:text-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2")}
            href={`mailto:${contact.email}`}
          >
            <Mail aria-hidden="true" className="size-4 opacity-65" />
            <span>E-Mail</span>
            <ArrowUpRight aria-hidden="true" className="ml-auto size-3.5 opacity-45" />
          </a>
          {profile.links.map((link) => (
            <a
              className={clsx(styles.linkRow, "inline-flex min-h-12 min-w-0 items-center gap-2.5 text-sm text-muted-foreground transition-colors hover:text-foreground focus-visible:text-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2")}
              href={link.href}
              key={link.href}
              rel="noreferrer"
              target="_blank"
          ...
          <span aria-disabled="true" className={clsx(styles.linkRow, "inline-flex min-h-12 min-w-0 items-center gap-2.5 text-sm text-muted-foreground opacity-35")}>
