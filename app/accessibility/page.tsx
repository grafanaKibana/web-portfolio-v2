    ...
    <main id="main" tabIndex={-1} className="mx-auto w-full max-w-4xl flex-1 px-6 py-12 [overflow-wrap:anywhere] focus:outline-none lg:py-20">
      <article className="mx-auto max-w-[68ch] text-base leading-7">
        <header>
          ...
          <p className="mt-6 leading-7 text-content-foreground" data-page-motion-intro>I aim to make this portfolio usable across devices, input methods, themes, and motion preferences.</p>
        </header>

        <section className="mt-10" data-page-motion-rows="children" data-page-motion-section>
          <h2 className="text-2xl leading-[1.875rem] font-semibold tracking-tight" data-page-motion-trigger>Measures used</h2>
          <p className="mt-4 leading-7 text-content-foreground">The site currently includes:</p>
          <ul className="mt-4 list-disc space-y-2 pl-6 leading-7 text-content-foreground">
        ...
        <section className="mt-10" data-page-motion-rows="children" data-page-motion-section>
          <h2 className="text-2xl leading-[1.875rem] font-semibold tracking-tight" data-page-motion-trigger>Conformance status</h2>
          <p className="mt-4 leading-7 text-content-foreground">WCAG 2.2 Level AA is a design target for this site. The site has not completed a formal WCAG conformance assessment, and no conformance claim is made.</p>
          <p className="mt-4">
        ...
        <section className="mt-10" data-page-motion-rows="children" data-page-motion-section>
          <h2 className="text-2xl leading-[1.875rem] font-semibold tracking-tight" data-page-motion-trigger>Known limitations</h2>
          <p className="mt-4 leading-7 text-content-foreground">Some long code examples scroll horizontally within their own containers. Accessibility of third-party websites linked from this portfolio is outside my control. Other issues may still exist because the site has not received a formal accessibility audit.</p>
        </section>

        <section className="mt-10" data-page-motion-rows="children" data-page-motion-section>
          <h2 className="text-2xl leading-[1.875rem] font-semibold tracking-tight" data-page-motion-trigger>Feedback</h2>
